...
impl super::Service {
	...
	/// Checks if the target user can send a specific invite by creating and
	/// discarding a new PDU. If creating the PDU fails, the user is not
	/// permitted to issue the invite.
