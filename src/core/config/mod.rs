...
fn default_db_cache_capacity_mb() -> f64 { 128.0 + parallelism_scaled_f64(128.0) }

fn default_pdu_cache_capacity() -> u32 { parallelism_scaled_u32(25_000).saturating_add(100_000) }
...
fn default_shortstatekey_cache_capacity() -> u32 {
	parallelism_scaled_u32(15_000).saturating_add(100_000)
}
