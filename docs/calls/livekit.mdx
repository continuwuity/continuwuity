...
<details>
   ...
   # compatibility instead of the one internal to livekit.  For more information look to the TURN
   # section of this guide or remove the TURN portion from this compose file and use the internal
   # TURN livekit server provided below
   ...
   services:
    lk-jwt-service:
        ...
        environment:
            - LIVEKIT_JWT_BIND=:8081
            - LIVEKIT_URL=wss://livekit.example.domain
            - LIVEKIT_KEY=MYLIVEKITKEY
            - LIVEKIT_SECRET=MYLIVEKITSECRET
            - LIVEKIT_FULL_ACCESS_HOMESERVERS=example.domain
        restart: unless-stopped
        networks:
            - caddy
        labels:
    ...
    homeserver:
        ...
        environment:
            CONTINUWUITY_SERVER_NAME: example.domain # EDIT THIS
            CONTINUWUITY_DATABASE_PATH: /var/lib/continuwuity
            CONTINUWUITY_PORT: 6167
            CONTINUWUITY_MAX_REQUEST_SIZE: 20000000 # in bytes, ~20 MB
            CONTINUWUITY_ALLOW_REGISTRATION: "true"
            CONTINUWUITY_REGISTRATION_TOKEN: 'MYREGTOKENCHANGEME' # A registration token is required when registration is allowed.
            CONTINUWUITY_ALLOW_FEDERATION: "true"
            CONTINUWUITY_ALLOW_CHECK_FOR_UPDATES: "true"
            CONTINUWUITY_TRUSTED_SERVERS: '["matrix.org"]'
            CONTINUWUITY_ADDRESS: 0.0.0.0
            CONTINUWUITY_QUERY_OVER_TCP_ONLY: "true"
            CONTINUWUITY_TURN_URIS: '["turn:turn.example.domain?transport=udp", "turn:turn.example.domain?transport=tcp"]'
            CONTINUWUITY_TURN_SECRET: "MYTURNSECRET"
