...
Alternatively, you can get a statically compiled musl binary by running `nix build git+https://forgejo.ellis.link/continuwuation/continuwuity#default-static-[x86_64/aarch64 (choose one)]`.
